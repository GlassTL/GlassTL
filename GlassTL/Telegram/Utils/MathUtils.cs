...
namespace BigMath.Utils
{
    ...
    public static class MathUtils
    {
        ...
        public static ulong[] ShiftRightSigned(ulong[] values, int shift)
        {
            ...
            shift %= (length * valueLength);     //This is the defined behavior of shift. Shifting by greater than the number of bits uses a mod
        ...
        {
            var pq256 = (Int256)pq;
            pq256.GetPrimeMultipliers(out Int256 p256, out Int256 q256);
            p = (Int128)p256;
            q = (Int128)q256;
        }
